...
#define  PANEL_PRZYKLAD11BUTTON           3       /* control type: command, callback function: Przyklad11ButtonCallback */
#define  PANEL_PRZYKLAD10BUTTON           4       /* control type: command, callback function: Przyklad10ButtonCallback */
#define  PANEL_PRZYKLAD9BUTTON            5       /* control type: command, callback function: Przyklad9ButtonCallback */
#define  PANEL_PRZYKLAD8BUTTON            6       /* control type: command, callback function: Przyklad8ButtonCallback */
#define  PANEL_PRZYKLAD7BUTTON            7       /* control type: command, callback function: Przyklad7ButtonCallback */
#define  PANEL_PRZYKLAD6BUTTON            8       /* control type: command, callback function: Przyklad6ButtonCallback */
#define  PANEL_PRZYKLAD5BUTTON            9       /* control type: command, callback function: Przyklad5ButtonCallback */
#define  PANEL_PRZYKLAD4BUTTON            10      /* control type: command, callback function: Przyklad4ButtonCallback */
#define  PANEL_PRZYKLAD3BUTTON            11      /* control type: command, callback function: Przyklad3ButtonCallback */
#define  PANEL_PRZYKLAD2BUTTON            12      /* control type: command, callback function: Przyklad2ButtonCallback */
#define  PANEL_PRZYKLAD1BUTTON            13      /* control type: command, callback function: Przyklad1ButtonCallback */
