...
#define  PANEL_PRZYKLAD6BUTTON            3       /* control type: command, callback function: Przyklad6ButtonCallback */
#define  PANEL_PRZYKLAD5BUTTON            4       /* control type: command, callback function: Przyklad5ButtonCallback */
#define  PANEL_PRZYKLAD4BUTTON            5       /* control type: command, callback function: Przyklad4ButtonCallback */
#define  PANEL_PRZYKLAD3BUTTON            6       /* control type: command, callback function: Przyklad3ButtonCallback */
#define  PANEL_PRZYKLAD2BUTTON            7       /* control type: command, callback function: Przyklad2ButtonCallback */
#define  PANEL_PRZYKLAD1BUTTON            8       /* control type: command, callback function: Przyklad1ButtonCallback */
