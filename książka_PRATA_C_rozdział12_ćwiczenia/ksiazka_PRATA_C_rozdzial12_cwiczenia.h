...
#define  PANEL_PRZYKLAD9BUTTON            3       /* control type: command, callback function: Przyklad9ButtonCallback */
#define  PANEL_PRZYKLAD8BUTTON            4       /* control type: command, callback function: Przyklad8ButtonCallback */
#define  PANEL_PRZYKLAD7BUTTON            5       /* control type: command, callback function: Przyklad7ButtonCallback */
#define  PANEL_PRZYKLAD6BUTTON            6       /* control type: command, callback function: Przyklad6ButtonCallback */
#define  PANEL_PRZYKLAD5BUTTON            7       /* control type: command, callback function: Przyklad5ButtonCallback */
#define  PANEL_PRZYKLAD4BUTTON            8       /* control type: command, callback function: Przyklad4ButtonCallback */
