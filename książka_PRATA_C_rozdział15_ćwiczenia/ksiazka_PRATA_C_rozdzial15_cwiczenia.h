...
#define  PANEL_PRZYKLAD7BUTTON            3       /* control type: command, callback function: Przyklad7ButtonCallback */
#define  PANEL_PRZYKLAD6BUTTON            4       /* control type: command, callback function: Przyklad6ButtonCallback */
#define  PANEL_PRZYKLAD5BUTTON            5       /* control type: command, callback function: Przyklad5ButtonCallback */
#define  PANEL_PRZYKLAD4BUTTON            6       /* control type: command, callback function: Przyklad4ButtonCallback */
#define  PANEL_PRZYKLAD3BUTTON            7       /* control type: command, callback function: Przyklad3ButtonCallback */
#define  PANEL_PRZYKLAD2BUTTON            8       /* control type: command, callback function: Przyklad2ButtonCallback */
#define  PANEL_PRZYKLAD1BUTTON            9       /* control type: command, callback function: Przyklad1ButtonCallback */
